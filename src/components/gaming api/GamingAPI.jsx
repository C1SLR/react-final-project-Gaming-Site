...
function GamingAPI() {
  ...
  return (
    <div>
      {gamesData.length > 0 ? (
        <div className="flex flex-wrap justify-center w-11/12 justify-self-center border gap-5 cursor-pointer">
          {gamesData.map((val) => (
            <div key={val.id} className=" hover:scale-105 hover:transition">
